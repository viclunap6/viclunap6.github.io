  ...
  const servicesData = {
    familia: {
      ...
      details: `
                ...
                <ul>
                    <li><strong>Planificación Patrimonial Familiar y Personal:</strong> Diseño de testamentos, fideicomisos y capitulaciones matrimoniales para la protección y sucesión del patrimonio.</li>
                    ...
                    <li><strong>Guardia, Custodia y Convivencia:</strong> Litigio y mediación enfocados en el interés superior del menor para definir la custodia y establecer regímenes de convivencia sanos y funcionales.</li>
                    <li><strong>Valoraciones Psicológicas y Servicio Social:</strong> Colaboración con expertos para la elaboración de peritajes y diagnósticos con validez judicial, fundamentales en disputas de custodia y casos de violencia familiar.</li>
                </ul>`,
      experts: [3, 5, 8],
    },
    deudor: {
      ...
      details: `
                ...
                <ul>
                    ...
                    <li><strong>Estrategias de Protección Patrimonial:</strong> Implementamos instrumentos legales (fideicomisos, afectación de patrimonio familiar) para proteger los bienes esenciales ante futuras contingencias.</li>
                </ul>`,
      experts: [3, 6, 9],
    },
    mercantil: {
      ...
      details: `
                ...
                <ul>
                    ...
                    <li><strong>Litigio Mercantil y Arbitraje:</strong> Representación en disputas sobre incumplimiento de contratos, conflictos entre socios y recuperación de cartera vencida.</li>
                    <li><strong>Análisis de Viabilidad Legal y de Mercado:</strong> Realizamos estudios de mercado desde una perspectiva legal para evaluar la viabilidad de nuevos productos o expansiones.</li>
                </ul>`,
      experts: [1, 4, 7],
    },
    laboral: {
      ...
      details: `
                <h3>Servicios Detallados</h3>
                <ul>
                     <li><strong>Contratación y Terminación de Relaciones Laborales:</strong> Diseño de contratos y estrategias para el manejo de procesos de terminación.</li>
                    <li><strong>Litigio Laboral Estratégico:</strong> Defensa ante los Tribunales Laborales, con un enfoque en la resolución eficiente de conflictos.</li>
                    <li><strong>Auditorías de Cumplimiento Normativo (NOM-035, REPSE, etc.):</strong> Verificación y adecuación de las políticas internas a la normativa vigente.</li>
                    <li><strong>Negociación Colectiva y Relaciones Sindicales:</strong> Asesoría y representación en la negociación de contratos colectivos de trabajo.</li>
                </ul>`,
      experts: [2, 1, 10],
    },
    internacional: {
      ...
      details: `
                <h3>Servicios Detallados</h3>
                <ul>
                    <li><strong>Contratos Internacionales:</strong> Elaboración y negociación de contratos de compraventa internacional, distribución y licencia, asegurando el cumplimiento de tratados.</li>
                    <li><strong>Registro y Protección de Marcas y Patentes:</strong> Gestión del registro de marcas y patentes a nivel nacional e internacional y defensa contra infracciones.</li>
                    <li><strong>Derechos de Autor y Secreto Industrial:</strong> Asesoría para la protección de software, obras creativas y secretos comerciales.</li>
                    <li><strong>Asesoría Aduanera y Cumplimiento:</strong> Orientación sobre clasificación arancelaria, regulaciones y procedimientos aduaneros para optimizar sus operaciones.</li>
                </ul>`,
      experts: [4, 1],
    },
    inmobiliario: {
      ...
      details: `
                <h3>Servicios Detallados</h3>
                <ul>
                    <li><strong>Adquisición de Inmuebles:</strong> Investigación exhaustiva (Due Diligence) de la situación legal de propiedades para asegurar adquisiciones libres de riesgos.</li>
                    <li><strong>Estructuración de Proyectos:</strong> Diseño de fideicomisos, coinversiones y otras estructuras legales y financieras para desarrollos residenciales y comerciales.</li>
                    <li><strong>Gestión de Permisos y Licencias:</strong> Tramitación de licencias de uso de suelo, construcción y todos los permisos necesarios ante autoridades.</li>
                    <li><strong>Contratos de Obra y Comercialización:</strong> Elaboración de contratos de construcción, arrendamiento, compraventa y regímenes de propiedad en condominio.</li>
                </ul>`,
      experts: [1, 2, 9],
    },
  };
